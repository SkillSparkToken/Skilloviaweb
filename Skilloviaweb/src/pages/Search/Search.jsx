      ...
      <div className="w-full max-w-2xl mx-auto h-screen overflow-hidden ">
        ...
        {skills.length > 0 && !isSkillLoading && (
          <div className="divide-y px-4">
            <div className="p-2 text-xs font-bold text-gray-600">
              Skills
            </div>
            {skills.map((skill, index) => (
              <div
                ...
                onClick={() =>
                  navigate(
                    `/explore-list?id=${skill._id}&category=${encodeURIComponent(
                      skill.title
                    )}`
                  )
                }
        ...
        {!isLoading &&
          ...
          skills.length === 0 && (
            <div className="text-center py-8">
              <p className="text-gray-500 font-medium">No users or skills found</p>
        ...
        {searchTerm.length < 3 && searchTerm.length > 0 && !isLoading && !isSkillLoading && (
          <div className="text-center py-8">
